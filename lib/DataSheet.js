...
var _InternalRowRenderer = require('./InternalRowRenderer');

var _InternalRowRenderer2 = _interopRequireDefault(_InternalRowRenderer);
...
var DataSheet = function (_PureComponent) {
  ...
  _createClass(DataSheet, [{
    ...
    key: 'isRowSelected',
    value: function isRowSelected(i) {
    ...
    key: 'isClearingRow',
    value: function isClearingRow(i) {
    ...
    value: function render() {
      ...
      var _props6 = this.props,
          ...
          data = _props6.data,
          keyFn = _props6.keyFn,
          equalityFn = _props6.equalityFn;
      var forceEdit = this.state.forceEdit;

      var _getState10 = this.getState(),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          data.map(function (row, i) {
            return _react2.default.createElement(_InternalRowRenderer2.default, {
              key: keyFn ? keyFn(i) : i,
              row: i,
              cells: row,
              forceEdit: forceEdit,
              editValue: _this4.isEditingRow(i) ? _this4.state.editValue : undefined,
              ...
              handleKeyboardCellMovement: _this4.handleKeyboardCellMovement,
              handleKey: _this4.handleKey,
              ...
              editI: _this4.isEditingRow(i) ? _this4.state.editing.i : undefined,
              editJ: _this4.isEditingRow(i) ? _this4.state.editing.j : undefined,
              clearingI: _this4.isClearingRow(i) ? _this4.state.clear.i : undefined,
              clearingJ: _this4.isClearingRow(i) ? _this4.state.clear.j : undefined,
              startI: _this4.isRowSelected(i) ? start.i : undefined,
              startJ: _this4.isRowSelected(i) ? start.j : undefined,
              endI: _this4.isRowSelected(i) ? end.i : undefined,
              endJ: _this4.isRowSelected(i) ? end.j : undefined,
...
DataSheet.propTypes = {
  ...
  equalityFn: _propTypes2.default.func,
